...
.method synthetic constructor <init>(Lcom/android/billingclient/api/t;)V
    ...
    iput p1, p0, Lcom/android/billingclient/api/f$a;->d:I
...
# virtual methods
.method public a(Lcom/android/billingclient/api/k;)Lcom/android/billingclient/api/f$a;
    .locals 1
    ...
    iput-object v0, p0, Lcom/android/billingclient/api/f$a;->e:Ljava/util/ArrayList;
...
.method public a()Lcom/android/billingclient/api/f;
    ...
    iget-object v0, p0, Lcom/android/billingclient/api/f$a;->e:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lcom/android/billingclient/api/f$a;->e:Ljava/util/ArrayList;
    ...
    invoke-virtual {v8}, Lcom/android/billingclient/api/k;->c()Ljava/lang/String;
    ...
    invoke-virtual {v8}, Lcom/android/billingclient/api/k;->f()Ljava/lang/String;
    ...
    invoke-direct {v0, v3}, Lcom/android/billingclient/api/f;-><init>(Lcom/android/billingclient/api/t;)V

    iget-object v3, p0, Lcom/android/billingclient/api/f$a;->e:Ljava/util/ArrayList;
    ...
    invoke-virtual {v2}, Lcom/android/billingclient/api/k;->f()Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lcom/android/billingclient/api/f;->b(Lcom/android/billingclient/api/f;Z)Z
    ...
    iget v1, p0, Lcom/android/billingclient/api/f$a;->d:I

    invoke-static {v0, v1}, Lcom/android/billingclient/api/f;->a(Lcom/android/billingclient/api/f;I)I

    iget-object v1, p0, Lcom/android/billingclient/api/f$a;->e:Ljava/util/ArrayList;

    invoke-static {v0, v1}, Lcom/android/billingclient/api/f;->a(Lcom/android/billingclient/api/f;Ljava/util/ArrayList;)Ljava/util/ArrayList;

    iget-boolean v1, p0, Lcom/android/billingclient/api/f$a;->f:Z
